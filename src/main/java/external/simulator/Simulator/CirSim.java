package external.simulator.Simulator;// CirSim.java (c) 2010 by Paul Falstad

// For information about the theory behind this, see Electronic Circuit & System Simulation Methods by Pillage


import external.simulator.Simulator.parts.*;
...
public class CirSim {
    ...
    private static final Class<?>[] dumpTypes = new Class[300];
    private static final Class<?>[] shortcuts = new Class[127];
    public boolean useFrame;
    public Vector<CircuitElm> elmList;
    Thread engine = null;
    Class addingClass;
    final int mouseMode = MODE_SELECT;
    ...
    final boolean dots = true;
    private Random random;
    private final int tempMouseMode = MODE_SELECT;
    ...
    private final String startCircuit = null;
    private final String startLabel = null;
    ...
    public final boolean euroResistors = false;
...
/*    void register(Class c, CircuitElm elm) {
    ...
    private void handleResize(int width, int height) {
        ...
        int dx = gridMask & ((circuitArea.getWidth() - (maxx - minx)) / 2 - minx);
        int dy = gridMask & ((circuitArea.getHeight() - (maxy - miny)) / 2 - miny);
        if (dx + minx < 0)
            dx = gridMask & (-minx);
        if (dy + miny < 0)
            dy = gridMask & (-miny);
...
/*        main.setLayout(new CircuitLayout());
        ...
        stoppedCheck = new Toggleable("Stopped");
...
//	setupList = new Vector();
        ...
        if (startCircuitText != null)
            importCircuit(startCircuitText);
        else if (stopMessage == null && startCircuit != null)
            importCircuit(startCircuit, startLabel);
        else
            importCircuit(null, 0, false);
...
/*        if (useFrame) {
    ...
    private void registerClasses() {
        ...
        CirSim.register(AnalogSwitch2Elm.class);
        CirSim.register(AnalogSwitchElm.class);
        CirSim.register(AndGateElm.class);
        CirSim.register(AntennaElm.class);
        CirSim.register(CapacitorElm.class);
        CirSim.register(CC2Elm.class);
        CirSim.register(CC2NegElm.class);
        CirSim.register(ACRailElm.class);
        CirSim.register(ClockElm.class);
        CirSim.register(CounterElm.class);
        CirSim.register(CurrentElm.class);
        CirSim.register(DACElm.class);
        CirSim.register(DCVoltageElm.class);
        CirSim.register(DecadeElm.class);
        CirSim.register(DeMultiplexerElm.class);
        CirSim.register(DFlipFlopElm.class);
        CirSim.register(DiodeElm.class);
        CirSim.register(FMElm.class);
        CirSim.register(FullAdderElm.class);
        CirSim.register(GroundElm.class);
        CirSim.register(HalfAdderElm.class);
        CirSim.register(InductorElm.class);
        CirSim.register(InverterElm.class);
        CirSim.register(InvertingSchmittElm.class);
        CirSim.register(JKFlipFlopElm.class);
        CirSim.register(LampElm.class);
        CirSim.register(LatchElm.class);
        CirSim.register(LEDElm.class);
        CirSim.register(LEDMatrixElm.class);
        CirSim.register(LogicInputElm.class);
        CirSim.register(LogicOutputElm.class);
        CirSim.register(MemristorElm.class);
        CirSim.register(MonostableElm.class);
        CirSim.register(MultiplexerElm.class);
        CirSim.register(NandGateElm.class);
        CirSim.register(NJfetElm.class);
        CirSim.register(NMosfetElm.class);
        CirSim.register(NorGateElm.class);
        CirSim.register(NTransistorElm.class);
        CirSim.register(OpAmpElm.class);
        CirSim.register(OpAmpSwapElm.class);
        CirSim.register(OrGateElm.class);
        CirSim.register(OutputElm.class);
        CirSim.register(PhaseCompElm.class);
        CirSim.register(PisoShiftElm.class);
        CirSim.register(PJfetElm.class);
        CirSim.register(PMosfetElm.class);
        CirSim.register(PotElm.class);
        CirSim.register(PTransistorElm.class);
        CirSim.register(RailElm.class);
        CirSim.register(RelayElm.class);
        CirSim.register(ResistorElm.class);
        CirSim.register(SchmittElm.class);
        CirSim.register(SCRElm.class);
        CirSim.register(SeqGenElm.class);
        CirSim.register(SevenSegDecoderElm.class);
        CirSim.register(SevenSegElm.class);
        CirSim.register(SipoShiftElm.class);
        CirSim.register(SparkGapElm.class);
        CirSim.register(SquareRailElm.class);
        CirSim.register(SRAMElm.class);
        CirSim.register(SweepElm.class);
        CirSim.register(Switch2Elm.class);
        CirSim.register(SwitchElm.class);
        CirSim.register(TappedTransformerElm.class);
        CirSim.register(TFlipFlopElm.class);
        CirSim.register(TimerElm.class);
        CirSim.register(TransformerElm.class);
        CirSim.register(TransLineElm.class);
        CirSim.register(TriodeElm.class);
        CirSim.register(TriStateElm.class);
        CirSim.register(TunnelDiodeElm.class);
        CirSim.register(VarRailElm.class);
        CirSim.register(VCOElm.class);
        CirSim.register(WireElm.class);
        CirSim.register(XorGateElm.class);
...
/*        int badnodes = 0;
    ...
    private void updateCircuit() {
        ...
        if (!stopped) {
            ...
            lastTime = 0;
        CircuitElm.powerMult = Math.exp(50 / 4.762 - 7);
...
/*        int f = (dotsCheckItem.getState()) ? 1 : 0;
        ...
        String dump = "$ " + f + " " +
                timeStep + " " + getIterCount() + " 0 " + CircuitElm.voltageRange + " 0\n";
        for (i = 0; i != elmList.size(); i++)
            dump += getElm(i).dump() + "\n";
/*        for (i = 0; i != scopeCount; i++) {
...
/*    void getSetupList(Menu menu, boolean retry) {
    ...
    private void importCircuit(String text) {
        importCircuit(text, false);
    }

    private void importCircuit(String text, boolean retain) {
        importCircuit(text.getBytes(), text.length(), retain);
        //titleLabel.setText("untitled");
    }

    private void importCircuit(String str, String title) {
        t = 0;
        System.out.println(str);
        try {
            URL url = new URL(getCodeBase() + "circuits/" + str);
            ByteArrayOutputStream ba = readUrlData(url);
            importCircuit(ba.toByteArray(), ba.size(), false);
        } catch (Exception e1) {
            try {
    ...
    private void importCircuit(byte b[], int len, boolean retain) {
        int i;
        if (!retain) {
            for (i = 0; i != elmList.size(); i++) {
                CircuitElm ce = getElm(i);
