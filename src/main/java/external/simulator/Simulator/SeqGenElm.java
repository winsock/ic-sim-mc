...
public class SeqGenElm extends ChipElm {
    ...
    public EditInfo getEditInfo(int n) {
        ...
        if (n == 0) {
            ...
            ei.checkbox = new Toggleable("Bit 0 set", (data & 1) != 0);
            return ei;
        }

        if (n == 1) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 1 set", (data & 2) != 0);
            return ei;
        }
        if (n == 2) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 2 set", (data & 4) != 0);
            return ei;
        }
        if (n == 3) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 3 set", (data & 8) != 0);
            return ei;
        }

        if (n == 4) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 4 set", (data & 16) != 0);
            return ei;
        }
        if (n == 5) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 5 set", (data & 32) != 0);
            return ei;
        }

        if (n == 6) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 6 set", (data & 64) != 0);
            return ei;
        }

        if (n == 7) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("Bit 7 set", (data & 128) != 0);
            return ei;
        }
        if (n == 8) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.checkbox = new Toggleable("One shot", oneshot);
            return ei;
        }
        return null;
    }
